...
class SynthVoiceOsc3 : public SynthesiserVoice
{
public:
	// Must return true if this voice object is capable of playing the given sound.
	bool canPlaySound(SynthesiserSound* sound)
	{
		return dynamic_cast<SynthSoundOsc3*>(sound) != nullptr;
	}
	...
	{
		return oscEnv.adsr(setOscType(), oscEnv.trigger) * level * gain;
	}
